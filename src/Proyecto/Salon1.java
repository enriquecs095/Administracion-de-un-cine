...
public class Salon1 extends javax.swing.JFrame {
   ...
   AsientosComprados3[] Salon3;
    ...
    public Salon1(ArrayList<RegistroPeliculas> peliculas,String valorVenta, int boletosVendidos, String fecha, AsientosComprados[] salon1, AsientosComprados2[] salon2, AsientosComprados3[] salon3 ) {
        initComponents();    
        this.Salon1=salon1;
         this.Salon2=salon2;
         this.Salon3=salon3;
        ...
        TxtAsientosDisponibles.setText(Integer.toString(Salon1.length-contador));    
        for (int i = 0; i < Salon1.length; i++) {
            if(Salon1[i]!=null)
                contador++;
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Enrique\\Documents\\NetBeansProjects\\Proyecto1Programacion2\\src\\Proyecto\\pantalla cine 1.gif")); // NOI18N
    ...
    public AsientosComprados Buscar() {
        for (AsientosComprados seleccionarAsiento : Salon1) {
    ...
    public boolean GuardarAsiento() {
        if (Buscar() == null){
            for (int i = 0; i < Salon1.length; i++) {
                if (Salon1[i] == null) {
                    Salon1[i] = new AsientosComprados(Integer.parseInt(TxtNumeroAsiento.getText()));
                }
                return true;
            }
        }
    ...
    public boolean QuitarAsiento(){
        for (int i = 0; i < Salon1.length; i++) {
            if(Salon1[i].getAsiento()==ListaAsientos.getSelectedIndex())
               Salon1[i]=null;
            return true;
        }   
    return false;
